...
I created this file as `README_GENERATED.md`. If you want, I can replace the project's `README.md` with this content or merge it into the existing README. Which do you prefer?
